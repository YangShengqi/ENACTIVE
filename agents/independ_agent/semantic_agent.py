...
class Semantic_Agent(AgentBase):
    ...
    def after_step_for_train(self, env):
        ...
        other_sum_mean_reward = [
            reward_method_independ.get_mean_team_reward_without_ith_aircraft(env, i, self.side, rewards_hyperparam_dict=self.rewards_hyperparam_dict) for
    ...
    def train(self, batchs):
        ...
        # batch_forward_size = 16 # for test #
