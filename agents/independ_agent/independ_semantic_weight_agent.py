...
from models.independ_nn.independ_semantic_weight_nn import Independ_Semantic_NN
...
class Independ_Semantic_Agent(AgentBase):
    ...
    def _create_model(self):
        ...
        model = Independ_Semantic_NN(Config.env.red, len(red_state_global[0]), len(red_atten_state[0][0]),
...
if __name__ == "__main__":
    ...
    red_agent = Independ_Semantic_Agent(target_type="without_self", agent_save_mode="origin", reward_type="expert_rewards",
                                        reward_hyperparam_dict=origin_reward_parameters)
    blue_agent = Independ_Semantic_Agent(target_type="without_self", agent_save_mode="origin", reward_type="expert_rewards",
                                         reward_hyperparam_dict=origin_reward_parameters)
