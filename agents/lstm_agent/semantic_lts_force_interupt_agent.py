...
from models.independ_nn.lts_force_interupt_lstm_nn import LTS_Force_Interupt_LSTM_NN
...
class Semantic_Lts_LSTM_Agent(AgentBase):
    ...
    def _create_model(self):
        ...
        model = LTS_Force_Interupt_LSTM_NN(self.state_dims['id_dim'],
    ...
    def after_step_for_train(self, env):
        ...
        shape_reward = [reward_shaping.get_ith_aircraft_shaped_reward(env, i, self.side, self.interval, [], [],
                                                                      self.rewards_hyperparam_dict) for i in
...
if __name__ == "__main__":
    ...
    red_agent = Semantic_Lts_LSTM_Agent(target_type="without_self", agent_save_mode="origin",
                                        reward_type="expert_rewards",
                                        reward_hyperparam_dict=origin_reward_parameters)
    blue_agent = Semantic_Lts_LSTM_Agent(target_type="without_self", agent_save_mode="origin",
                                         reward_type="expert_rewards",
                                         reward_hyperparam_dict=origin_reward_parameters)
