...
from models.release_nn.osc_nn import OSC_NN
...
class OSC_Agent(AgentBase):
    ...
    def _create_model(self):
        ...
        model = OSC_NN(self.state_dims['id_dim'],
    ...
    def single_gpu_train(self, batchs, model_optimizer, gpu_rank=0, world_size=1):
        ...
        for epoch in range(Config.epochs):
            ...
            for i in range(optim_iter_num):
                ...
                #
                self.model(states_global_b)  # todo use for synchronize loss, delete it later
                #
...
if __name__ == "__main__":
    ...
    for _ in range(100):
        ...
        red_agent.train([batch_r, batch_b])
        blue_agent.train([batch_b, batch_r])
        print("bbb")
